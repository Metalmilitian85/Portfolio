...
function Projects() {
  return (
    <div id="Projects" className="text-center pt-7 text-black border-4 rounded-lg border-gray-500 bg-black w-[80%] mx-auto my-12 shadow-xl shadow-gray-300 md:max-w-[60%]">
