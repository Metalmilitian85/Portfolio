  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-blue font-bold">
        ...
        <ul className="hidden md:flex text-[#4bb3f8]">
            ...
            <Link to='/skills'><li className="p-4">SKILLS</li></Link>
        ...
        <div className={!nav ? "fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#4bb3f8] ease-in-out duration-200" : "fixed left-[-100%]"}>
          ...
          <ul className="uppercase p-4">
            <Link to='/'><li className="p-4 border-b border-gray-600">MAIN</li></Link>
            <Link to='/about'><li className="p-4 border-b border-gray-600">ABOUT</li></Link>
            <Link to='/skills'><li className="p-4 border-b border-gray-600">SKILLS</li></Link>
            <Link to='/projects'><li className="p-4 border-b border-gray-600">PROJECTS</li></Link>
            <Link to='/contact'><li className="p-4 border-b border-gray-600">CONTACT</li></Link>
          </ul>
        </div>
    </div>
  )
